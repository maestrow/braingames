...
var JQuery = function (__exports) {
    var JQuery = __exports.JQuery = jquery$2;

    var appendTo = __exports.appendTo = function (target, selector) {
        return selector.appendTo(target);
    };

    var remove$$1 = __exports.remove = function (selector) {
        return selector.remove();
    };

    var get = __exports.get = function (index, selector) {
        return selector.get(index);
    };

    var on = __exports.on = function (event, handler, selector) {
        return function (arg00) {
            return function (arg10) {
                return selector.on(arg00, arg10);
            };
        }(event)(handler);
    };

    var text = __exports.text = function (selector) {
        return selector.text();
    };

    var css = __exports.css = function (prop, value, selector) {
        return function (arg00) {
            return function (arg10) {
                return selector.css(arg00, arg10);
            };
        }(prop)(value);
    };
...
var Utils = function (__exports) {
    var random = {};

    var shuffle = __exports.shuffle = function (lst) {
        return map$$1(function (tuple) {
            return tuple[0];
        }, toList(sortWith(function (x, y) {
            return compare(function (tuple_1) {
                return tuple_1[1];
            }(x), function (tuple_1) {
                return tuple_1[1];
            }(y));
        }, map$$1(function (i) {
            return [i, randomNext(0, 2147483647)];
        }, lst))));
    };

    return __exports;
}({});
var GameLogic = function (__exports) {
    var generateNumbers = __exports.generateNumbers = function (max$$1) {
        return Utils.shuffle(toList(range(1, max$$1)));
    };

    return __exports;
}({});
var View = function (__exports) {
    var gamestate = (Object.defineProperty(__exports, 'gamestate', {
        get: function get() {
            return gamestate;
        },
        set: function set(x) {
    ...
    var container = __exports.container = jQuery(".game-field");
    var progress = __exports.progress = jQuery(".progress");

    var createResultNum = __exports.createResultNum = function (num) {
        return jQuery(fsFormat("<div class=\"result-num\">%d</div>")(function (x) {
            return x;
        })(num));
    };

    var clickHandler = __exports.clickHandler = function (e) {
        var target = jQuery(e.target);
        var num = Number.parseInt(JQuery.text(target));

        if (gamestate === num) {
            (function (selector) {
                return JQuery.appendTo(progress, selector);
            })(createResultNum(num));

            JQuery.css("visibility", "hidden", target);
            gamestate = gamestate + 1;
        }
    };

    var createBlock = __exports.createBlock = function (num) {
        return JQuery.on("click", function (e) {
            clickHandler(e);
        }, jQuery(fsFormat("<div class=\"block\">%d<div>")(function (x) {
            return x;
        })(num)));
    };
    ...
    var start = __exports.start = function () {
        iterate(function (block) {
            ...
            return map$$1(function (num) {
                return createBlock(num);
            }, list);
        }(GameLogic.generateNumbers(42)));
    };
